...
import com.glynch.jollama.client.JOllamaClientRequestException;
import com.glynch.jollama.support.DefaultResponseStatusErrorHandler;
import com.glynch.jollama.support.ResponseStatusErrorHandler;
...
public class DefaultJOllamaApi implements JOllamaApi {
    ...
    public Response execute(Request request) {
        try {
            ...
            throw new JOllamaClientRequestException(e.getMessage(), e, request.url().toString(), request.method());
        }
    }
